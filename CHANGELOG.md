...
See [the release note](https://github.com/fujidaiti/smooth_sheets/releases/tag/v1.0.4) for more details.
...
See [the release note](https://github.com/fujidaiti/smooth_sheets/releases/tag/v1.0.0) for more details.
