...
({Widget testWidget, ValueGetter<NavigatorState> getNavigator}) _boilerplate({
  ...
  final testWidget = CupertinoApp(
    ...
    home: CupertinoPageScaffold(key: homeKey, child: Container()),
  );
...
Widget _boilerplateSheet({
  ...
  return SheetModelOwner(
    key: modelOwnerKey,
    factory: (_, config) =>
        _TestSheetModel(config: config, initialOffset: initialOffset),
    config: _TestSheetModelConfig(maxOffset: maxOffset, minOffset: minOffset),
    child: BareSheet(
      key: key,
      child: Container(color: CupertinoColors.systemBackground, height: height),
    ),
  );
}
...
void main() {
  ...
  group('Regression test', () {
    ...
    testWidgets('Crashes when pushing a new sheet while another is closing', (
      tester,
    ) async {
    ...
    testWidgets('Crashes when popping a route just below the modal sheet', (
      tester,
    ) async {
            ...
            child: Column(
              ...
              children: [
                CupertinoButton(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                      CupertinoModalSheetRoute<dynamic>(builder: buildSheet),
                    );
                  },
                ),
                CupertinoButton(
          ...
          child: Center(
            child: CupertinoButton(
              ...
              onPressed: () {
                Navigator.of(
                  context,
                ).push(MaterialPageRoute<dynamic>(builder: buildDetailPage));
              },
            ),
          ),
        );
