...
void main() {
  group('WidgetTesterX.tap', () {
    ...
    setUp(() {
      testWidget = MaterialApp(
        home: Scaffold(
          body: ElevatedButton(onPressed: () {}, child: Text('Tap me')),
        ),
      );
    });

    testWidgets('should successfully tap on the widget', (tester) async {
      await tester.pumpWidget(testWidget);
      await tester.tap(find.text('Tap me'));
      expect(tester.takeException(), isNull);
    });

    testWidgets('should throw an error when the widget is not found', (
      tester,
    ) async {
      await tester.pumpWidget(testWidget);
  ...
  group('WidgetTesterX.hitTest', () {
    ...
    testWidgets('should not throw an error when the specified widget '
        'can receive pointer events at in-bounds locations', (tester) async {
      await tester.pumpWidget(testWidget);
      // Top-left corner
    ...
    testWidgets('should throw an error when the specified widget '
  ...
  group('WidgetTesterX.startDrag', () {
    ...
    testWidgets('Start an upward drag', (tester) async {
      ...
      expect(verticalDragDownDetails?.globalPosition, center);
      expect(verticalDragStartDetails?.globalPosition.dy, lessThan(center.dy));
      expect(verticalDragUpdateDetails, isNull);
  ...
  group('WidgetTesterX.getLocalRect', () {
    ...
    testWidgets('should return correct local rectangle of the widget '
        'when no ancestor is specified', (tester) async {
      await tester.pumpWidget(testWidget);
      expect(
    ...
    testWidgets('should return correct local rectangle of the widget '
        'with a specified ancestor', (tester) async {
      await tester.pumpWidget(testWidget);
      expect(
        tester.getLocalRect(
    ...
    testWidgets('should throw when widget is not found', (tester) async {
      await tester.pumpWidget(testWidget);
      expect(
    ...
    testWidgets('should throw when ancestor is not found', (tester) async {
      await tester.pumpWidget(testWidget);
      expect(
        () => tester.getLocalRect(
          find.byKey(Key('inner')),
  ...
  group('WidgetTesterX.dragUpward and dragDownward', () {
    ...
    testWidgets('dragUpward should drag widget upward by deltaY', (
      tester,
    ) async {
      await tester.pumpWidget(testWidget);
